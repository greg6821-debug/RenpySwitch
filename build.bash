...
python2.7 setup.py || true
PYGAME_SDL2_STATIC=1 python2.7 setup.py || true
popd

pushd renpy-source/module
rm -rf gen gen-static
RENPY_DEPS_INSTALL=/usr/lib/x86_64-linux-gnu:/usr:/usr/local python2.7 setup.py || true
RENPY_DEPS_INSTALL=/usr/lib/x86_64-linux-gnu:/usr:/usr/local RENPY_STATIC=1 python2.7 setup.py || true
popd


pushd pygame_sdl2-source
python2.7 setup.py build
python2.7 setup.py install_headers
python2.7 setup.py install
popd

pushd renpy-source/module
RENPY_DEPS_INSTALL=/usr/lib/x86_64-linux-gnu:/usr:/usr/local python2.7 setup.py build
RENPY_DEPS_INSTALL=/usr/lib/x86_64-linux-gnu:/usr:/usr/local python2.7 setup.py install
popd
