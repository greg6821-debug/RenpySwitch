...
find source/module -mindepth 2 -type f -exec mv -f -t source/module {} +
find source/module -type d -empty -delete

rsync -avm --include='*/' --include='*.h' --exclude='*' pygame_sdl2-source/ include/module/pygame_sdl2
find include/module/pygame_sdl2 -mindepth 2 -type f -exec mv -f -t include/module/pygame_sdl2 {} +
