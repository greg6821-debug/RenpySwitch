...
declare -A missing_files=(
    ["renpy.audio.filter.c"]="renpy-source/module/gen-static/renpy.audio.filter.c"
    ["renpy.text.hbfont.c"]="renpy-source/module/gen-static/renpy.text.hbfont.c"
    ["_renpytfd.c"]="renpy-source/module/gen-static/_renpytfd.c"
    ["renpy.arguments.c"]="renpy-source/module/gen-static/renpy.arguments.c"
    ["renpy.execution.c"]="renpy-source/module/gen-static/renpy.execution.c"
)
